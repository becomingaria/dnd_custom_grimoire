...
export default function SpellCard({ spell, index = 0, compact = false }: SpellCardProps) {
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        style={{ background: `linear-gradient(90deg, transparent, ${getSchoolColor(spell.school)}, transparent)` }}
        initial={{ opacity: 0.3 }}
