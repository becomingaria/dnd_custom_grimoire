...
export default function HomePage() {
    ...
    return (
        <div className='space-y-16 py-8'>
            ...
            <div className='relative overflow-hidden rounded-2xl border border-grimoire-border bg-grimoire-card px-8 py-16 text-center'>
                ...
                >
                    ...
                    <p className='mx-auto mt-4 max-w-xl font-rajdhani text-lg text-grimoire-text-muted'>
                        Your personal arcane library. Manage, craft, and master
                        every spell you desire.
                    </p>
            ...
            {/* Stats */}
            <div>
                <h2 className='mb-4 font-cinzel text-xl font-bold text-grimoire-text-base'>
                    Arcane Overview
                </h2>
                <div className='grid grid-cols-2 gap-4 sm:grid-cols-4'>
                    {stats.map(({ label, value, icon: Icon, color }, i) => (
                        ...
                        >
                            ...
                            <span className='font-rajdhani text-sm text-grimoire-text-faint'>
                                {label}
                            </span>
                        </motion.div>
                    ))}
            ...
            <div className='grid gap-4 md:grid-cols-2'>
                <motion.div whileHover={{ scale: 1.015 }}>
                    ...
                    >
                        ...
                        <p className='font-rajdhani text-grimoire-text-muted'>
                            Browse all {spells.length} spells. Filter by school,
                            level, or class. Create your own homebrew spells.
                        </p>
                    </Link>
                </motion.div>
                ...
                <motion.div whileHover={{ scale: 1.015 }}>
                    ...
                    >
                        ...
                        <p className='font-rajdhani text-grimoire-text-muted'>
                            Manage your {characters.length} character
                            {characters.length !== 1 ? "s" : ""}. Track known
                            and prepared spells for each one.
                        </p>
                    </Link>
                </motion.div>
            </div>
