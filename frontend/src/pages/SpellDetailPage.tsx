...
export default function SpellDetailPage() {
    ...
    async function handleUpdate(data: UpdateSpellInput) {
        if (!spellId) return
        await updateSpell.mutateAsync({ spellId, input: data })
        setShowEdit(false)
    }
        ...
        <div className='mx-auto max-w-2xl space-y-6 py-8'>
            ...
            >
                ...
                <div className='border-b border-grimoire-border p-6 pb-5'>
                    ...
                    <div className='mt-4 grid grid-cols-3 gap-3'>
                        {[
                            ...
                            <div
                                key={label}
                                className='rounded-lg border border-grimoire-border/60 bg-grimoire-surface/50 p-3 text-center'
                            >
                                <Icon
                                    size={14}
                                    className='mx-auto mb-1 text-grimoire-text-faint'
                                />
                                <p className='font-mono text-sm text-grimoire-text-base'>
                                    {value}
                                </p>
                                <p className='font-rajdhani text-[10px] uppercase tracking-widest text-grimoire-text-faint'>
                                    {label}
                                </p>
                            </div>
                        ))}
                ...
                <div className='space-y-5 p-6'>
                    ...
                    {/* Description */}
                    <div>
                        <h3 className='mb-2 font-cinzel text-sm font-bold uppercase tracking-widest text-grimoire-text-faint'>
                            Description
                        </h3>
                        <p className='whitespace-pre-line font-rajdhani leading-relaxed text-grimoire-text-muted'>
                            {spell.description}
                        </p>
                    </div>
            ...
            >
                <SpellForm
                    ...
                    isLoading={updateSpell.isPending}
                />
            </Modal>
                ...
                <div className='space-y-4'>
                    ...
                    <div className='flex justify-end gap-3'>
                        ...
                        <motion.button
                            ...
                            whileHover={{
                                scale: deleteSpell.isPending ? 1 : 1.03,
                            }}
                            whileTap={{
                                scale: deleteSpell.isPending ? 1 : 0.97,
                            }}
                        >
